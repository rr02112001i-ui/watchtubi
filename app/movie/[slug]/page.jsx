...
export async function generateMetadata({ params }) {
  ...
  if (CATEGORIES.includes(slug)) {
    ...
    return {
      title: `WatchTubi - ${title} Movies`,
      description: `Explore the ${title} movies collection on WatchTubi.`,
    };
  }
  ...
  if (genreMatch) {
    ...
    return {
      title: `WatchTubi - ${genreName} Movies`,
      description: `Discover ${genreName} movies on WatchTubi.`,
    };
  }

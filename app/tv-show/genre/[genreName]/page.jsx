...
export async function generateMetadata({ params }) {
  ...
  const pageUrl = `https://watchtubi.netlify.app/tv-show/genre/${genreName}`;
  const imageUrl = 'https://live.staticflickr.com/65535/55043944463_e255301f42_b.jpg';

  return {
    title: `WatchTubi - ${title} TV Series`,
    description: `Find and watch the best ${title} TV series for free on WatchTubi.`,
    openGraph: {
      title: `WatchTubi - ${title} TV Series`,
      description: `Find and watch the best ${title} TV series for free on WatchTubi.`,
      url: pageUrl,
